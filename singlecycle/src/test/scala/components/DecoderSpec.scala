...
class DecoderSpec extends AnyFlatSpec with ChiselScalatestTester with should.Matchers {
  ...
  it should "Decode an ADD instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("add x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an ADDI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("addi x1, x2, 5"))
      c.clock.step()
  ...
  it should "Decode an SUB instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sub x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an LUI instruction (type U)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("lui x23, 0x12345"))
      c.clock.step()
  ...
  it should "Decode an AUIPC instruction (type U)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("auipc x23, 0x12345"))
      c.clock.step()
  ...
  it should "Decode an SLL instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sll x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an SLLI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("slli x1, x2, 5"))
      c.clock.step()
  ...
  it should "Decode an SRL instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("srl x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an SRLI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("srli x1, x2, 5"))
      c.clock.step()
  ...
  it should "Decode an SRA instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sra x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an SRAI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("srai x1, x2, 1"))
      c.clock.step()
  ...
  it should "Decode an AND instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("and x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an ANDI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("andi x7, x24, -1"))
      c.clock.step()
  ...
  it should "Decode an OR instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("or x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an ORI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("ori x7, x24, -1"))
      c.clock.step()
  ...
  it should "Decode an XOR instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("xor x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an XORI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("xori x7, x24, -1"))
      c.clock.step()
  ...
  it should "Decode an SLT instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("slt x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an SLTI instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("slti x7, x24, -1"))
      c.clock.step()
  ...
  it should "Decode an SLTU instruction (type R)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sltu x1, x2, x3"))
      c.clock.step()
  ...
  it should "Decode an SLTIU instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sltiu x7, x24, -1"))
      c.clock.step()
  ...
  it should "Decode an BEQ instruction (type B)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("beq x21, x10, -1366"))
      c.clock.step()
  ...
  it should "Decode an BNE instruction (type B)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("bne x21, x10, -1366"))
      c.clock.step()
  ...
  it should "Decode an BLT instruction (type B)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("blt x21, x10, -1366"))
      c.clock.step()
  ...
  it should "Decode an BGE instruction (type B)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("bge x21, x10, -1366"))
      c.clock.step()
  ...
  it should "Decode an BLTU instruction (type B)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("bltu x21, x10, -1366"))
      c.clock.step()
  ...
  it should "Decode an BGEU instruction (type B)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("bgeu x21, x10, -1366"))
      c.clock.step()
  ...
  it should "Decode an JAL instruction (type J)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("jal x21, -699052"))
      c.clock.step()
  ...
  it should "Decode an JALR instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("jalr x21, x1, 1234"))
      c.clock.step()
  ...
  it should "Decode an LB instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("lb x1, 16(x2)"))
      c.clock.step()
  ...
  it should "Decode an LH instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("lh x1, 16(x2)"))
      c.clock.step()
  ...
  it should "Decode an LBU instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("lbu x1, 16(x2)"))
      c.clock.step()
  ...
  it should "Decode an LHU instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("lhu x1, 16(x2)"))
      c.clock.step()
  ...
  it should "Decode an LW instruction (type I)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("lw x1, 16(x2)"))
      c.clock.step()
  ...
  it should "Decode an SB instruction (type S)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sb x10, -81(x21)"))
      c.clock.step()
  ...
  it should "Decode an SH instruction (type S)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sh x10, -81(x21)"))
      c.clock.step()
  ...
  it should "Decode an SW instruction (type S)" in {
    test(new InstructionDecoder) { c =>
      c.io.instructionIn.poke(makeBin("sw x10, -81(x21)"))
      c.clock.step()
  ...
  def validateResult(
    ...
    c.io.decodedInstruction.expect(inst)
    c.io.destinationRegister.peekInt() should be(rd)
    c.io.sourceRegister1.peekInt() should be(rs1)
    c.io.sourceRegister2.peekInt() should be(rs2)
    c.io.immediate.peekInt() should be(imm)
    c.io.useALU.peekBoolean() should be(toALU)
    c.io.branch.peekBoolean() should be(branch)
    c.io.useImmediate.peekBoolean() should be(use_imm)
    c.io.jump.peekBoolean() should be(jump)
    c.io.load.peekBoolean() should be(load)
    c.io.store.peekBoolean() should be(store)
  }
}
