...
#set_property PACKAGE_PIN R2  [get_ports {io_read}]					
...
set_property PACKAGE_PIN V13 [get_ports {io_addChecker}]					
set_property PACKAGE_PIN V3  [get_ports {io_val1}]					
set_property PACKAGE_PIN W3  [get_ports {io_val2}]					
